...
, _version(this, st::mainMenuVersionLabel) {
    ...
    _telegram->setRichText(textcmdLink(1, qsl("Wrappy Desktop")));
    _telegram->setLink(1, MakeShared<UrlClickHandler>(qsl("https://desktop.Wrappy.org")));
    ...
    _version->setLink(1, MakeShared<UrlClickHandler>(qsl("https://desktop.Wrappy.org/changelog")));
