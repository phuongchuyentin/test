...
constexpr str_const AppNameOld = "Wrappy Win (Unofficial)";
constexpr str_const AppName = "Wrappy Desktop";

constexpr str_const AppId = "{53F49750-6209-4FBF-9CA8-7A333C87D1ED}"; // used in updater.cpp and Setup.iss for Windows
constexpr str_const AppFile = "Wrappy";
...
#ifdef CUSTOM_API_ID
#include "../../../WrappyPrivate/custom_api_id.h" // Custom API id and API hash
#else
...
#include "../../../WrappyPrivate/beta_private.h" // private key for downloading closed betas
#else
